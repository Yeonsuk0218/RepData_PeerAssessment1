...
``` {r readActivity function, echo=TRUE}
...
``` {r createHistogram function, echo=TRUE}
...
``` {r createTimeSeriesPlot function, echo=TRUE}
...
``` {r imputeMissingValues function, echo=TRUE}
##--------------------
## D. Imputing missing values
##--------------------
...
``` {r createTimeSeriesPlotForWeekdaysWeekends function, echo=TRUE}
